...
import biryani from '../../images/default_dish.jpg';
        ...
        return (
            <div>
                <div className="card" style={{ width: '18rem' }}>
                    <img src={biryani} className="img-thumbnail" onError={(e) => { e.target.onerror = null; e.target.src = "../../images/default_dish.jpg" }} />
